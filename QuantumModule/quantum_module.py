...
# Persist the trained classifier and scaler for inference
torch.save(model.state_dict(), "quantum_classifier.pt")
joblib.dump(scaler, "quantum_scaler.pkl")
print("Saved quantum classifier to quantum_classifier.pt and scaler to quantum_scaler.pkl")
